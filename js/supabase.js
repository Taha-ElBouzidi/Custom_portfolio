...
const SUPABASE_URL = getEnv("SUPABASE_URL") || "https://ghykglfgbbcvctnaeakp.supabase.co";
const SUPABASE_ANON_KEY = getEnv("SUPABASE_ANON_KEY") || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdoeWtnbGZnYmJjdmN0bmFlYWtwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjI0MjU1OTksImV4cCI6MjA3ODAwMTU5OX0.ZaFY-sdtComkV0dEvO6axkADyNUlNN6-kb0a9fzX75M";
